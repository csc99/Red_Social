<?php
	...
	verificar_session();//Verifica sesión

	//Incluimos los archivos del index
	require('header.php');
	require('subir.php');
	if(isset($_POST['publicar']) && !empty($_FILES) && !empty($_POST['contenido'])){
		$destino = 'subidos/';
	...
	$post = post::mostrar_todo($amigos[0]['amigos']);
